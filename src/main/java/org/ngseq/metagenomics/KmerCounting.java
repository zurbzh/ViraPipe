...
public class KmerCounting {
    ...
    public static void main(String[] args) throws IOException {
        ...
        JavaRDD<String> text = sc.textFile(in);



        JavaPairRDD<String, Tuple2<String, Long>> getCountedKmers = text.mapPartitionsToPair(records -> {

            ArrayList<Tuple2<String, Tuple2<String, Long>>> id_kvalue = new ArrayList<Tuple2<String, Tuple2<String, Long>>>();
            ...
            while (records.hasNext()) {
                ...
                for (String br : broadcastedkmers.getValue()) {
                    if (result.containsKey(br)) {
                        Tuple2<String, Tuple2<String, Long>> kmer_value = new Tuple2<String, Tuple2<String, Long>>(id, new Tuple2<>(br, result.get(br)));
                        id_kvalue.add(kmer_value);
                    } else{
                        int value = 0;
                        Tuple2<String, Tuple2<String, Long>> kmer_value = new Tuple2<String, Tuple2<String, Long>>(id, new Tuple2<>(br, Long.valueOf(value)));
                        id_kvalue.add(kmer_value);
            ...
            return id_kvalue.iterator();
        });


        JavaPairRDD<String, Iterable<Tuple2<String, Long>>> combinedbySeqId = getCountedKmers.groupByKey();

        for (Tuple2 ss : combinedbySeqId.collect()){
            System.out.println(ss._1() + " - kmers: " + ss._2());
        }
