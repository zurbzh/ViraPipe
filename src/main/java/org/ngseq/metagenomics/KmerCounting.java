...
public class KmerCounting {
    ...
    public static void main(String[] args) throws IOException {
        ...
        JavaPairRDD<String, ArrayList<Long>> getCountedKmers = csvfile.mapPartitionsToPair(records -> {

            ArrayList<Tuple2<String, ArrayList<Long>>> id_kvalues = new ArrayList<Tuple2<String, ArrayList<Long>>>();
            ...
            while (records.hasNext()) {
                ...
                ArrayList<Long> codons = new ArrayList<Long>();

                for (String br : broadcastedkmers.getValue()) {
                    if (result.containsKey(br)) {
                        codons.add(result.get(br));

                    } else{
                        int value = 0;
                        codons.add(Long.valueOf(value));
                    }

                }
                id_kvalues.add(new Tuple2<String, ArrayList<Long>>(id,codons));
        ...
        JavaRDD<String> id_kmers_species = getCountedKmers.mapPartitions(records -> {
            ...
            while (records.hasNext()) {
                Tuple2<String, ArrayList<Long>> seq = records.next();
                String id = seq._1();
                ArrayList<Long> arr = new ArrayList<Long>(seq._2);
                String line = "";
                for (Long l : arr) {
                    line += "\t" +  l.toString();
                }
